 ...
 * @brief Static factory that builds concrete IDevice instances from JSON, dispatching by
 *        DeviceType to the matching registry entry looked up via DeviceRegistry.
 */
...
/**
 * @class DeviceFactory
 * @brief Static, non-instantiable factory that builds concrete IDevice instances (camera,
...
public:
    ...
    /**
     * @brief Builds an IDevice from a JSON object, validating that the required top-level keys
     *        (id, name, type, config) are present before dispatching to create().
     * @param[in] o      JSON object describing the device
     * @param[in] parent QObject parent passed through to the created device
    ...
    /**
     * @brief Dispatches device creation to the type-specific create* helper matching `type`.
     * @param[in] type   device family to create
    ...
    /**
     * @brief Creates a camera device from the registry entry matching `obj`'s sub-type.
     * @param[in] obj    JSON object describing the camera device
     * @param[in] parent QObject parent passed through to the created device
    ...
    static IDevice* createCamera(const QJsonObject& obj,
                                 QObject* parent = nullptr);
    /**
     * @brief Creates a PLC device from the registry entry matching `obj`'s sub-type.
     * @param[in] obj    JSON object describing the PLC device
     * @param[in] parent QObject parent passed through to the created device
    ...
    static IDevice* createPlcDevice(const QJsonObject& obj,
                                    QObject* parent = nullptr);
    /**
     * @brief Creates a vision-output device from the registry entry matching `obj`'s sub-type.
     * @param[in] obj    JSON object describing the vision-output device
     * @param[in] parent QObject parent passed through to the created device
    ...
    static IDevice* createVisionOutputDevice(const QJsonObject& obj,
                                             QObject* parent = nullptr);
    /**
     * @brief Creates a robot device from the registry entry matching `obj`'s sub-type.
     * @param[in] obj    JSON object describing the robot device
     * @param[in] parent QObject parent passed through to the created device
