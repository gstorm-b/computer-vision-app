...
public:
    ...
    QStringList completerStrings(const QtProperty* property) const;
...
public Q_SLOTS:
    ...
    void setCompleterList(QtProperty *property, const QStringList& strs);
    void setInitialString(QtProperty* property, const QString& val);
Q_SIGNALS:
	void valueChanged(QtProperty* property, const QString& val);
	void regExpChanged(QtProperty* property, const QRegularExpression& regExp);
    void completerChanged(QtProperty* property, const QStringList &strs);
protected:
	QString valueText(const QtProperty* property) const override;
	void initializeProperty(QtProperty* property) override;
	void uninitializeProperty(QtProperty* property) override;
